...
from selfdrive.car.kia_soul.carstate import CarState, get_can_parser   #2018.09.02 DV add kia soul
from selfdrive.car.kia_soul.values import CruiseButtons, CM, BP, AH, CAR, HONDA_BOSCH #2018.09.02 DV add Kia Soul
...
try:
  from selfdrive.car.kia_soul.carcontroller import CarController
except ImportError:
  CarController = None
