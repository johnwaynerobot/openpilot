...
def create_brake_command_soul(packer, apply_brake):
  ...
  values["BRAKE_COMMAND_pedal_command"] = apply_brake/100   #2018.09.24 add * 1000 for big endian to little endian
...
def create_gas_command(packer, gas_amount):
  ...
  if enable:
    ...
    values["THROTTLE_COMMAND_pedal_command"] = gas_amount/100  #2018.09.25 time 1000 to check
