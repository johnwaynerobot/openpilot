...
class CarInterface(object):
  ...
  def get_params(candidate, fingerprint):
    ...
    ret.steerKf = 0.000002  # conservative feed-forward
    ...
    #  ret.safetyParam = 8 # define in /boardd/boardd.cc
      ...
      tire_stiffness_factor = 0.677
      #ret.steerKpV, ret.steerKiV = [[0.6], [0.18]]
      ret.steerKpV, ret.steerKiV = [[0.03], [0.18]]
      ret.steerKiBP, ret.steerKpBP = [[0.], [0.]]  # 2018.09.04 from hyundai
      ret.longitudinalKpBP = [0., 5., 35.]
      ret.longitudinalKpV = [1.2, 0.8, 0.5]
      ret.longitudinalKiBP = [0., 35.]
   ...
   # ret.minEnableSpeed = -1. if (stop_and_go or ret.enableGasInterceptor) else 25.5 * CV.MPH_TO_MS
    ret.minEnableSpeed = -1. if (stop_and_go or ret.enableGasInterceptor) else -1.0 * CV.MPH_TO_MS #2018.09.18 min enable speed test#
