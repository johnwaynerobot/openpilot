...
class CarInterface(object):
  ...
  def get_params(candidate, fingerprint):
    ...
    if candidate == CAR.CIVIC:
      ...
      #tire_stiffness_factor = 0.444 # not optimized yet
      tire_stiffness_factor = 0.82  #20181101 setting from @kegman 2018pilot
      #ret.steerKpV, ret.steerKiV = [[0.38], [0.11]]
      ret.steerKpV, ret.steerKiV = [[0.5], [0.22]]   #20181101 setting from @kegman 2018pilot https://github.com/kegman/openpilot/blob/kegman-devel/selfdrive/car/honda/interface.py
      ret.longitudinalKpBP = [0., 5., 35.]
      ret.longitudinalKpV = [1.2, 0.8, 0.5]
      ret.longitudinalKiBP = [0., 35.]
      ret.longitudinalKiV = [0.18, 0.12]
    ...
    #et.minEnableSpeed = -1. if (stop_and_go or ret.enableGasInterceptor) else 25.5 * CV.MPH_TO_MS
    ret.minEnableSpeed = -1. if (stop_and_go or ret.enableGasInterceptor) else -1. * CV.MPH_TO_MS  #test 2018.09.18
